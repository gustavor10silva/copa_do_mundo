...
conmebol = 'https://pt.wikipedia.org/wiki/Eliminat%C3%B3rias_da_Copa_do_Mundo_FIFA_de_2018_-_Am%C3%A9rica_do_Sul'
concacaf = 'https://pt.wikipedia.org/wiki/Eliminat%C3%B3rias_da_Copa_do_Mundo_FIFA_de_2018_-_Am%C3%A9rica_do_Norte,_Central_e_Caribe'
uefa = 'https://pt.wikipedia.org/wiki/Eliminat%C3%B3rias_da_Copa_do_Mundo_FIFA_de_2018_-_Europa'
caf = 'https://pt.wikipedia.org/wiki/Eliminat%C3%B3rias_da_Copa_do_Mundo_FIFA_de_2018_-_%C3%81frica'
afc = 'https://pt.wikipedia.org/wiki/Eliminat%C3%B3rias_da_Copa_do_Mundo_FIFA_de_2018_-_%C3%81sia'
#ofc = 'https://pt.wikipedia.org/wiki/Eliminat%C3%B3rias_da_Copa_do_Mundo_FIFA_de_2018_-_Oceania'
...
df_conmebol.to_csv('C:/Users/Rustabo/Projetos/copa_do_mundo/bronze/2018/df_conmebol.csv', sep=';', index=False)
...
df_concacaf.to_csv('C:/Users/Rustabo/Projetos/copa_do_mundo/bronze/2018/df_concacaf.csv', sep=';', index=False)
...
df_uefa.to_csv('C:/Users/Rustabo/Projetos/copa_do_mundo/bronze/2018/df_uefa.csv', sep=';', index=False)
...
df_caf.to_csv('C:/Users/Rustabo/Projetos/copa_do_mundo/bronze/2018/df_caf.csv', sep=';', index=False)
...
df_afc = pd.DataFrame(columns=['Pos.', 'vdeSeleção', 'Pts', 'J', 'V', 'E', 'D', 'GP', 'GC', 'SG'])
for i in range(10,12):
    df_afc_full = pd.read_html(str(tables_afc[i]))[0]
    df_afc_partial = df_afc_full.loc[:, 'Pos.':'SG']
    df_afc = pd.concat([df_afc, df_afc_partial])
df_afc.to_csv('C:/Users/Rustabo/Projetos/copa_do_mundo/bronze/2018/df_afc.csv', sep=';', index=False)