...
# importando o dataframe de classificados 2006
df_classif_2006 = pd.read_csv('C:/Users/Rustabo/Projetos/copa_do_mundo/gold/2006/df_classif_2006.csv', sep=';')
selecoes_classificadas = list(df_classif_2006['selecao'])


# extraindo os codigos das selecoes
ano = 2006
ano_param_url = 'fifa07_3/'
